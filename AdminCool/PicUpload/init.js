...
AjaxProcesser.prototype.getInformation=function(info){
	...
	case "uploaded":
		...
		break;
	case "processing":
		uploadInfo.alt="正在处理图片: " + info.description;
		uploadInfo.stepId=4;
		break;
	case "processed":
		uploadInfo.alt="处理数据完毕,准备保存图片...";
		uploadInfo.stepId=5;
		break;
	case "saving":
		uploadInfo.alt="正在保存图片: " + info.description;
		uploadInfo.stepId=6;
		break;
	case "saved":
		uploadInfo.alt="图片保存完毕,上传成功!";
