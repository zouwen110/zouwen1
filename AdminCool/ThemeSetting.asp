...
response.Write "<script language='javascript'>alert('该主题启用成功，已更新首页，其它页面请到“生成管理”处“生成栏目”和“生成内容”才会更新！');location.href='ThemeSetting.asp';</script>"
end if
%>
	...
	<tr><td height="400" valign="top"  class='forumRow'><br>
	    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <p>2、启用了某个主题后，默认只会自动生成网站首页，其它页面需要手动到"生成管理"处<a href="html_items.asp">生成栏目</a>和<a href="html_article.asp">生成内容</a>才会看到修改后的效果。</p>
            <p>3、如果主题无法更新，可有有以下原因：(1)你的空间写入权限未打开;(2)浏览器缓存问题，页面需要多刷新下才会看到;(3)启用主题后，你没有到生成管理处生成其它页面。</p>
			 <p>4、系统自带了多款主题，还有更多主题在逐步开发中，请随时关注海纳个人博客官方网站(www.hitux.com)。</p></td>
          </tr>
          <tr>
            <td height="10" ></td>
          </tr>
